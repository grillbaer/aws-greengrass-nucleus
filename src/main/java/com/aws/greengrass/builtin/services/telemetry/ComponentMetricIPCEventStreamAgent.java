...
public class ComponentMetricIPCEventStreamAgent {
    ...
    // throw IllegalArgumentException is request params are invalid
    // throw AuthorizationException is request params don't match access control policy
    ...
    // throws AuthorizationException is not authorized
